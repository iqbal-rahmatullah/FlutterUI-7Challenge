...
import 'package:seven_project/pages/empty_page2.dart';
import 'package:seven_project/pages/get_started1.dart';
import 'package:seven_project/pages/get_started2.dart';
...
import 'package:seven_project/pages/sign_in2.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: RatingPage2(), //Change this to view other page
    );
  }
}
